...
void GroundSpawn::HandleUse(Client* client, string type){
	...
	if(client->GetVersion() <= 561 && (typeLwr == "" || (typeLwr == "chop" && collection_skill == "Foresting") || 
		(typeLwr == "collect" && collection_skill == "Collecting") || GetHarvestMessageName(true, true) == typeLwr))
